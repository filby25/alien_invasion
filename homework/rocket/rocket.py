...
class Rocket:
    ...
    def __init__(self):
        ...
        self.rocket_settings.screen_width = self.screen.get_rect().width
        self.rocket_settings.screen_height = self.screen.get_rect().height
        pygame.display.set_caption("rocket hw")

        self.rocket_image=Rocket_image(self)
